...
| 2026-09-24 | Golden Gate `SharedSupport.dmg` root inventoried | Contains `com_apple_MobileAsset_MacSoftwareUpdate/`, `com_apple_MobileAsset_MobileSoftwareUpdate_MacUpdateBrain/`, and `InstallInfo.plist`; mounted read-only |
