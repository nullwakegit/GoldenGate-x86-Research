...
| 2026-09-24 | Golden Gate `SharedSupport.dmg` extracted from the XAR | `ls -lh` reports about 17 GB; stored in a temporary directory; verification and read-only mounting are next |
