...
| 2026-09-24 | Golden Gate kernelcache entries extracted for identification | 33 MB copies extracted; `file` reports generic `data` for both, so their format and architecture remain unresolved |
